...
номер страницы в панели «СИСТ. РЕГИСТРЫ». Дисковод, винчестер и ПЗУ самого
контроллера не эмулируются — что из этого следует, разобрано в
[docs/smk512.md](docs/smk512.md).
