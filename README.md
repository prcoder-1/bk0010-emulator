...
| `bk_key` | нажать клавишу по имени (`enter`, `right`, `рус`) или символу; `frames:N` — нажать, прогнать N кадров, отпустить (нужно играм, опрашивающим бит удержания 0177716, напр. Digger) |
